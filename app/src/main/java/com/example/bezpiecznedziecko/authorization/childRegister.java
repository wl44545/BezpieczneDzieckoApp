...
public class childRegister extends AppCompatActivity {
    ...
    String txt_account_type, txt_parent; // txt_gender,
            ...
            public void onClick(View view) {
                try {
                    registerChild(edt_login.getText().toString(), edt_password.getText().toString(), edt_first_name.getText().toString(),
                            edt_last_name.getText().toString(), edt_email.getText().toString(), edt_phone_number.getText().toString(), txt_parent, txt_account_type);
    ...
    private void registerChild(String login, String plain_password, String first_name, String last_name,
        ...
        out.writeBytes("token="+getString(R.string.child_token)+"&login="+login+"&password="+password+"&salt="+salt+"&first_name="+first_name+"&last_name="+last_name+"&email="+email+"&phone_number="+phone_number+"&parent="+txt_parent+"&account_type="+account_type+"&pesel= &gender= ");//"&pesel="+pesel+"&gender="+gender+"&parent="+txt_parent+"&account_type="+account_type);
        out.flush();
        out.close();
