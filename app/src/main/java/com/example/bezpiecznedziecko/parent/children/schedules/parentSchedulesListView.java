...
public class parentSchedulesListView extends RecyclerView.Adapter<parentSchedulesListView.ViewHolder> {

    private ArrayList<Schedules.Schedule> schedulesList;
    private OnNoteListener onNoteListener;

    public parentSchedulesListView(OnNoteListener inputOnNoteListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.parent_schedules_list_view, parent, false);
